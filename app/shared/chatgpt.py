...
async def classificarTagsGerais(raizes, ramos):
    ...
    message = [
        {"role": "system", "content": ("A Resposta deverá ser uma unica palavra; Irá receber dois arrays em formato de string: o primeiro array contém 20 tags raízes e o segundo contém 3 tags ramos; Retorne somente com 1 palavra o nome da tag raiz que mais tem haver com os ramos. ex: 'Games'")},
